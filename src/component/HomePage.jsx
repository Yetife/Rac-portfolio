...
function HomePage() {
    return (
        <section id="home" className="md:py-40 pt-24 pb-20 flex items-center justify-center h-screen w-full bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-gray-800">
